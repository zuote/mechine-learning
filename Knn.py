...
def test_KNN():
    ...
    train_image = "D:\mnist\\train-images-idx3-ubyte"
    test_image = "D:\mnist\\t10k-images-idx3-ubyte"
    train_label = "D:\mnist\\train-labels-idx1-ubyte"
    test_label = "D:\mnist\\t10k-labels-idx1-ubyte"
    # 读取数据
    train_x = read_image(train_image)  # train_data
    test_x = read_image(test_image)  # test_data
